	...
	<div class="sectioncontent" style="height:100vh;">
		...
		<HeroHeader>
			...
			<svelte:fragment slot="paragraph"
				...
				students with all of the resources that CRLS and Cambridge have to offer.</svelte:fragment
			>
		</HeroHeader>
			...
			<Faq>
				<div>
					...
					<FaqItem>
						...
						<p class="text-gray-600">
							If you are interested in helping us out on our project, send us an <u
								><a
									target="_blank"
									href="https://mail.google.com/mail/?view=cm&fs=1&to=crlspathfinders25@gmail.com&su=CRLS%20PathFinders%20Mentee"
									>email</a
								></u
