...
export async function createClub(advisor_email, clubDays, club_description, club_name, president_email, room_number, secret_password, start_time, status, vicePresidentsEmails) {
...
export async function editClub(advisor_email, clubDays, club_description, club_name, president_email, room_number, secret_password, start_time, status, vicePresidentsEmails) {
